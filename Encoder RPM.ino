...
void right_wheel_pulse() {
  ...
  if(val == LOW) {
    Direction_Forward_A_Wheel_R = false; // Reverse
  }
  else {
    Direction_Forward_A_Wheel_R = true; // Forward
  }
   
  if (Direction_Forward_A_Wheel_R) {
...
void left_wheel_pulse() {
  ...
  if(val == LOW) {
    Direction_Forward_A_Wheel_L = false; // Reverse
  }
  else {
    Direction_Forward_A_Wheel_L = true; // Forward
  }
   
  if (Direction_Forward_A_Wheel_L) {
